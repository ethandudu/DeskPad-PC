...
public class DeskPad {
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept()) {
                    ...
                    while ((inputLine = in.readLine()) != null) {
                        ...
                        if (json.has("type") && json.getString("type").equals("key")) {
                            pressKey(json.getString("message"));
                        } else if (json.has("type") && json.getString("type").equals("keys")) {
    ...
    private static void pressKey(String key) throws AWTException {
